...
export const useDecompteBack = (backendCounter: number | null, intervalsStarted: boolean, setBackendCounter: { (value: SetStateAction<number | null>): void; (arg0: number): void; }, backendtime: number) => {
