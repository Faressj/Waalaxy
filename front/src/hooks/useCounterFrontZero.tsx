...
export const useCounterFrontZero = (queue: any, actions: any, frontendCounter: number | null, setActionRemoving: (arg0: null) => void, setQueue: (arg0: (prevQueue: any) => any) => void, setActions: (arg0: (prevActions: any) => any) => void, updateAction: (arg0: any) => void, setFrontendCounter: { (value: SetStateAction<number | null>): void; (arg0: any): void; }, frontendtime: number, toggle: boolean) => {
    ...
    }, [queue, actions, frontendCounter, setActionRemoving, setQueue, setActions, updateAction, setFrontendCounter, frontendtime, toggle]);
}